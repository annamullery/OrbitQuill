 ...
 * This file demonstrates how to integrate Orbitquill with a web frontend
 */

// For React/Vue/Angular applications
export class OrbitquillClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new OrbitquillClient(provider, contractAddress);
